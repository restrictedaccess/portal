...
<form method="POST" name="form" action="admin_assign_bp_affiliatephp.php" >
...
<div class="box_contacted_leads" >Add/Delete Business Partner's Affiliate
...
WHERE
a.status = 'ACTIVE' AND
a.work_status ='AFF' AND
f.business_partner_id =$id;";
		  //echo $sqlGetAff;
$r=mysql_query($sqlGetAff);
$counter=0;
echo "<b>Current List of Affiliate</b>";
...
<label class="leads_wrapper_label" style="width:50px;"><a href="admin_assign_bp_affiliatephp.php?id=<?=$id;?>&aff_id=<?=$fid;?>">remove</a></label>
</span>
<?  
}
}else{
echo "<p><b>NOTE :</b> The current status of accessibility of this Business Partner to any Affiliate's Leads is <b>&quot;$access_aff_leads&quot;</b>. <br>
Please try to edit $agent_fname&nbsp;$agent_lname account. Click <a href='adminnaddagent.php?id=$id&edit=TRUE'><b>HERE</b></a></p>";
}
?>
<div style=" clear:both;"></div>
</div>
...
<fieldset>
<?
$sqlGetAllAffiliates="SELECT agent_no,fname,lname FROM agent WHERE work_status='AFF' AND status='ACTIVE' ORDER BY fname ASC;";
