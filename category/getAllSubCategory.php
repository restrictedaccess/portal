...
while(list($sub_category_id, $sub_category_name)=mysql_fetch_array($data))
{
	?>
		<div style=" float:left; padding:2px; border-bottom:#CCCCCC solid 1px;">
			...
			<div style="float:left; display:block; text-align:right;">&nbsp;<span class="ctrl_btn" title="Delete <?=$sub_category_name;?>" onClick="deleteCategories('subcat',<?=$sub_category_id;?>)"><img src="./images/delete.png"></span>						</div>
