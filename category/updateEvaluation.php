...
echo "<div style = 'padding:5px;text-align:center;font:12px Arial;'><b>Evaluation Updated!</b></div>";
...
<div style="padding:5px; background:#CCCCCC; border:#CCCCCC outset 1px; font:bold 12px Arial; color:#993300;">Applicants Evaluation Form</div>
	<div style="padding:5px; border:#CCCCCC solid 1px;font:12px Arial; background:#FFFFFF;">
		...
		<?=$evaluation_date;?>
		<p><label>&nbsp;</label><b style="color:#0000FF;"><a href="javascript: staff_timezone(<?php echo $userid; ?>); ">Update Time-Zone</a></b></p>        
      ...
      Yes </p>
		...
		<p><span style="float:left;"><b>Add Evaluation Comments</b></span>
		  ...
		  <input type="text" name="notes" id="notes"  style="width:430px; font:11px tahoma;" />
