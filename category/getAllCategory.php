...
&nbsp;<span class="ctrl_btn" title="Delete <?=$category_name;?>" onClick="deleteCategories('cat',<?=$category_id;?>)"><img src="./images/category/delete.png"></span>
	<?
			...
			while(list($sub_category_id, $sub_category_name)=mysql_fetch_array($data))
			{
				...
				?>
					<li><a href="adminadvertise_category.php?t10_category_id=<?=$sub_category_id;?>&t10_category_name=<?=$sub_category_name;?>" target="_parent"><?=$sub_category_name;?></a> (<?=$count;?>) (<a href="javascript: editSubCat('<?=$sub_category_name;?>',<?php echo $sub_category_id; ?>); ">Edit</a>)</li>						
				<?
			}
		?>
	</div>	
