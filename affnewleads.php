...
FROM leads l
WHERE status = 'New Leads' AND agent_id =$agent_no ORDER BY timestamp DESC;";
}
//echo $query;
$counter = 0;
...
<div id="page_desc">
Dear Affiliate,<br> <br>
  <p>Below are the some leads generated from your affiliate links.   These leads have not been contacted by the RemoteStaff Sales Team. .</p>
  <p>Ones a contact has been made, the lead will be transferred to “Contacted Leads” tab. You’ll have an idea on where we are at on the sales process as you have access to this information. </p>
  <p>We generally contact leads within 5 business days.  If you have a lead that you want to be prioritized and be called earlier please email sales@remotestaff.com.au . </p>
  <p>Cheers, <br>
Team RemoteStaff
</p>
</div>
...
<div class="box_new_leads" >New Leads List
