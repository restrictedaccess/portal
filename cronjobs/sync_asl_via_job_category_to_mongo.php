...
include('../conf/zend_smarty_conf.php');
	...
	new Zend_Db_Expr("(SELECT job_sub_category_id FROM mongo_job_orders_categories WHERE tracking_code = CONCAT(DATE_FORMAT(tbr.date_added, '%Y%m%d'), jsca.sub_category_id, tbr.leads_id, '-ASL')) AS job_order_sub_category_id"),
...
$msg_body =json_encode(array("script"=>"/portal/cronjobs/sync_asl_via_job_category_to_mongo.php","query"=>$sql->__toString()));
