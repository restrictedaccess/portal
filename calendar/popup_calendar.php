...

{
	...
	{
		$_SESSION['back_link'] = "../leads_information.php?userid=".$l_id;		
	}
	else
	{
		$_SESSION['back_link'] = "../leads_information.php?userid=".$_SESSION['l_id'];	
	}
...

{
	...
	$_SESSION['back_link'] = "../client_workflow.php?id=".$_SESSION['l_id'];
...

{
	...
	$_SESSION['back_link'] = "../leads_information.php?id=".$_SESSION['l_id'];
...
if(!isset($_SESSION['agent_no']) || !isset($_SESSION['admin_id']))
...
<table width="100%" border="0" bgcolor="#3E97CF" cellpadding="10" cellspacing="0">
	...
	<tr>
		...
		<td><input type="button" value="<<< BACK TO LEAD PAGE" name="new" <?php echo $button_style; ?> onClick="javascript: window.location='<?php echo $_SESSION['back_link']; ?>'; "></td>

		<td width="24%" align="left" valign="top" bgcolor="#3E97CF" colspan="2"> <font color="#FFFFFF"><strong>
						...
						<table width="100%" border="0" bgcolor="#ffffff" cellpadding="5" cellspacing="1">
							...
							<tr>
								...
								<td width="100%">
									...
									<input type="button" value="Yes" name="delete" <?php echo $button_style; ?> onClick="javascript: window.location='?<?php echo "appointment_cancel=".$id."&delete_confirmed=yes&yearID=".$yearID."&monthID=".$monthID."&dayID=".$dayID; ?>'">

									<input type="button" value="Cancel" name="cancel" <?php echo $button_style; ?> onClick="javascript: window.location='?<?php echo "yearID=".$yearID."&monthID=".$monthID."&dayID=".$dayID; ?>'">
		...
		<td>
			...
			<table width=100% cellspacing=1 border=0 cellpadding=7 bgcolor=#fefefe>
				...
				<tr>
					...
					<td onClick="javascript: window.location='?yearID=<?php echo $yearID; ?>&monthID=<?php echo $monthID; ?>&dayID=<?php echo $dayID; ?>&appointment_cancel='+id_selected;" bgcolor=#FFFFFF onmouseover="javascript:this.style.background='#3E97CF';" onmouseout="javascript:this.style.background='#FFFFFF'; ">
