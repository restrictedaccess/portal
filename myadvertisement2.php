...
FROM posting p JOIN leads l ON l.id = p.lead_id WHERE p.lead_id= $client_id  AND p.status='NEW' ORDER BY p.date_created DESC;";
...
<ul>
<li ><a href="myadvertisement.php" title="Active Job Advetisements"><span>Active Job Advetisements</span></a></li>
<li class="selected" ><a href="myadvertisement2.php" title="Pending Job Advetisements"><span>Pending Job Advetisements</span></a></li>
