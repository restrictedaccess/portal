...
<td width='4%' align=center><b><font size='1'>Inquiries</font></b></td>
<td width='4%' align=center><b><font size='1'>Hits</font></b></td>
...
<?
	$bgcolor="#f5f5f5";
	while(list($id,$tracking_no,$date,$creator,$details,$points) = mysql_fetch_array($result))
	{
		$counter=$counter+1;
		if($points=="")$points=0;
		if ($hits =="")$hits="0";
...
?>
		<tr bgcolor=<? echo $bgcolor;?>>
			  ...
			  <td width='4%' align=center><font size='1'><? echo $hits;?></font></td>
