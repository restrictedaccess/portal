								...
								<font color="#000000"><strong>
									...
									<table width="100%"  border="0" cellspacing="0" cellpadding="3">
									  ...
									  <tr>
										...
										<td><input type="checkbox" ID="update_type_option_id" name="type_option" value="online meeting" onClick="ToggleInput(this, 'type_id');"></td>
                        ...
                        <tr>
                          <td width="24%" align="left" valign="top" bgcolor="#F1F1F3"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                            <tr>
                              ...
                              <td><input id="update_all_day_id" type="checkbox" name="all_day" value="checkbox"></td>
