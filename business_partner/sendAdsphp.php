...
if($booking_code=="")
{
	//$txt="<a href='http://www.remotestaff.com.au/redirect.php?booking_code=$agent_code' target='_blank'>http://www.remotestaff.com.au/$agent_code</a>";
...
for ($i=0; $i<count($lead_email);$i++)
{
	...
	$message="<div style='margin-left:10px; margin-right:5px; margin-top:10px;padding:5px 0 5px 10px;font-family:Tahoma; font-size:13px; '>
			  <p><img src='http://www.philippinesatwork.com/dev/norman/Chris/images/banner/remoteStaff-small.jpg'></p>
			  ".$hi."
			  <p class='message' align='justify'>".$mess."<br></p>
			  <h5>".$txt."</h5>
			  </div>
			  <div style='background: url(http://www.philippinesatwork.com/dev/norman/Chris/images/banner/remote.jpg);  margin-left:10px; margin-right:5px;'>&nbsp;</div>
...
<table width='770' border='0' align='center' cellpadding='0' cellspacing='0'  style='margin:0;padding:0;' >
  ...
  <tr>
    <td><table width='760' border='0' align='center' cellpadding='0' cellspacing='0' >
	  ...
	  <tr><td>
	  <a href='http://www.remotestaff.com.au/redirect.php?booking_code=$booking_code' target='_blank'>
