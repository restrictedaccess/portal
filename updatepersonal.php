...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="32">
				<tr><td width="736"  bgcolor="#abccdd" >
					<table width="736">
						<tr>
							<td style="font: 8pt verdana; ">&#160;&#160;<b>Welcome, <?=$fname;?>	</td>
...
<? if ($mess!="") {echo "<center><b><font color='#FF0000' size='3'>There's an  ".$mess." Please try again</font></b></center>"; }?></td></tr>
...
<tr><td>
<table width=98% cellspacing=0 cellpadding=0 align=center><tr><td class=msg><b>Fill in this section to give employers a snapshot of your profile.</b> <br></td>
</tr></table>
<br>
<form method="POST" name="frmPersonal" action="updatepersonalphp.php"onsubmit="return checkFields();">
...
<INPUT size='30' class='text' style="width:270px" name='fname' value="<? echo $fname;?>"></td></tr>
<tr><td width=30% align=right>Family/Last Name :</td>
<td colspan=2 ><INPUT size="30" class=text style="width:270px" name="lname" value="<? echo $lname;?>"></td></tr>
<tr valign=top><td align=right width=30% >Date of Birth :</td>
<td colspan=2>
<select name="bday" class="text">
<? echo $dayoptions;?>
</select>
...
- <input type="text" name="byear" size="4" maxlength=4 style='width=50px' value="<? echo $byear;?>"  class=text> (YYYY)</td></tr>
...
- 
<INPUT maxLength=30 size=15 style='width=120px' class="text" name="msia_new_ic_no" value="<? echo $msia_new_ic_no;?>"><br>&nbsp;&nbsp;
...
<tr valign=top><td align=right width=30% >Home Working Environment :</td><td><input name="home_working_environment" type="radio" value="private room" <?=$selected1;?> >
Private Room&nbsp;<input type="radio" <?=$selected2;?> name="home_working_environment" value="shared room">Shared Room&nbsp;<input type="radio" <?=$selected3;?> name="home_working_environment" value="living room">Living Room&nbsp;</td></tr>
<tr valign=top><td align=right width=30% >Internet Connection :</td><td><input type="radio" name="internet_connection" <?=$checked1;?> value="WI-FI">WI-FI&nbsp;<input type="radio" <?=$checked2;?> name="internet_connection" value="DIAL-UP">Dial-Up&nbsp;<input type="radio" <?=$checked3;?> name="internet_connection" value="DSL">DSL&nbsp;</td></tr>
<tr valign=top><td align=right width=30% >Internet Provider (ISP) :</td><td><INPUT size=30 style='width:270px' class="text" name="isp" value="<?=$isp;?>"></td></tr>
<tr valign=top><td align=right width=30% >List of Computer Hardware:</td><td><textarea name="computer_hardware" cols="30" rows="5"><?=$computer_hardware;?></textarea></td></tr>
<tr valign=top><td width=30% height="23" align=right >Headset Quality :</td>
...
<td><? echo $email;?><INPUT type="hidden" maxLength=100 size=30 style='width:270px' class="text" name="email" value="<? echo $email;?>" onChange="javascript: ValidateOneEmail(this);"></td></tr>
<tr valign=top><td align=right width=30% >Password :</td>
<td><?=$pass;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/portal/forgotpass.php?user=applicant" target="_blank">Change Password</a></td></tr>
...
<td><INPUT maxLength=100 size=30 style='width:270px' class="text" name="alt_email" value="<? echo $alt_email;?>" onChange="javascript: if (Trim(this.value) != '') {	if (Trim(this.value) == Trim(form.email.value)) { alert('Please enter your alternate email different from your Primary Email'); validated = false; return false; } else { return ValidateOneEmail(this); }}"><br>&nbsp;&nbsp;<img src='images/arrow.gif'><font class=tip>will be used if primary email is not reachable</font></td></tr><tr valign=top><td align=right width=30% >Mobile No. :</td>
<td>
...
- <INPUT maxLength=15 size=15 style='width:136px' class="text" name="handphone_no" value="<? echo $handphone_no;?>">
</td></tr>
<tr valign=top><td align=right width=30% >Telephone No. :</td>
<td><INPUT maxLength=5 size=5 style='width:60px' class="text" name="tel_area_code" value="<? echo $tel_area_code;?>">
- <INPUT maxLength=20 size=22 style='width:196px' class=text name="tel_no" value="<? echo $tel_no;?>"><br>
<font class=tip>Area Code - Number</font></td></tr>
<tr valign=top><td align=right width=30% valign=top rowspan=2>Address :</td><td>
<INPUT  size=30 style='width:270px' class="text" name="address1" value="<? echo $address1;?>"></td></tr>
<tr valign=top><td><INPUT maxLength=50 size=30 style='width:270px' class="text" name="address2" value="<? echo $address2;?>"></td></tr>
<tr valign=top><td align=right width=30% >Postal Code :</td>
<td><INPUT maxLength=20 size=30 style='width:270px' class="text" name="postcode" value="<? echo $postcode;?>"></td></tr>
<tr valign=top><td align=right width=30% >Country :</td><td>
<select name="country_id" onChange="javascript: emptyLocationSelect(this.form.state, this.options[this.selectedIndex].value,this.form.msia_state_id,this.form.city, this.form.location_code) ;" style="width:270px;font:8pt, Verdana">
<option value="00">-</option>
<? echo $country_idoptions ;?>
</select>
</td></tr><tr><td align=right width=30% >State/Region :</td><td><select name="msia_state_id" value="NC" onChange="return enterCity(form.msia_state_id.options[form.msia_state_id.options.selectedIndex].value, this.form.city, this.form.location_code, true);" style="width:270px;font:8pt verdana"><OPTION value="00">Select State/Region &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</OPTION><OPTION value="00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</OPTION></select> <br><INPUT maxLength=20 size=30 style='width:270px' class="text" name="state" value="<? echo $state;?>" ><input type=hidden name="state2" value=""></td></tr><tr valign=top><td align=right width=30% >City :</td>
<td><input type=hidden name=location_code value=""><INPUT maxLength=20 size=30 style='width:270px' class="text" name="city" value="<? echo $city;?>"></td></tr></table><br clear=all><table width=100% cellspacing=8 cellpadding=2 border=0 align=left ><tr><td width=100% bgcolor=#DEE5EB colspan=3><b>&nbsp;Online Contact Info (OPTIONAL)</a></b></td></tr><tr><td><div id='internet_acc' class='toggleshow'><table width='100%' cellpadding=2 cellspacing=4 border=0><tr valign=top><td align=left colspan=2><a name='ia'>Fill in your Instant Messaging (IM) Usernames here to provide us with an alternative way to contact you. <font color=red><b>Note: This section is fully optional.</b></font></a><br><br></td></tr><tr valign=top><td align=right width=30% >MSN Messenger ID :</td><td><INPUT maxLength=80 size=30 style='width:200px' class=text name="msn_id" value="<? echo $msn_id;?>"></td></tr><tr valign=top><td align=right width=30% >Yahoo! Messenger ID :</td><td><INPUT maxLength=80 size=30 style='width:200px' class="text" name="yahoo_id" value="<? echo $yahoo_id;?>"></td></tr><tr valign=top><td align=right width=30% >ICQ Number :</td><td><INPUT maxLength=80 size=30 style='width:200px' class=text name="icq_id" value="<? echo $icq_id;?>"></td></tr><tr valign=top><td align=right width=30% >Skype ID :</td><td><INPUT maxLength=80 size=30 style='width:200px' class="text" name="skype_id" value="<? echo $skype_id;?>"></td></tr><tr><td colspan=2>&nbsp;</td></tr></table></div></td></tr></table><br clear=all>
<br>
<table width=100% border=0 cellspacing=1 cellpadding=2><tr><td align=center><INPUT type=submit value='Update' name="btnSubmit" class="button" style='width:120px'></td></tr></table></form></td></tr></table></td></tr></table><script language="javascript">
