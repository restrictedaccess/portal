...
if($lead_status!=""){
	...
	$lead_status = " AND l.status = 'pending' ";
	$folder = "pending"; 
}
...
function goto(id) 
{
	location.href = "apply_action2.php?id="+id+"&tab=pending";
}
function check_val()
{
...
<p><label><b>Actions :</b></label><input type="submit" name="search" value="Search"> &nbsp;<input type="button" name="add" value="Add New Lead" onClick="self.location='addnewlead.php'"/> </p>
