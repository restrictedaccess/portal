...
$leads_list = sprintf('leads_list/index.php?lead_status=%s', $lead_status);
...
if($access_all_leads == 'YES'){
	...
	if($business_developer_id == 'all'){
		if($lead_status == "All"){
			$status_Search = " l.status != 'Inactive' ";
		}else{
...
if($order_by){
	$search_flag = True;
	include 'leads_list_order_by_view.php';
	
}else{
	//default view of the list
	include 'leads_list_default_view.php';
