...
*/
function mkYearHead(){
return "<table width='90%' class=\"".$this->cssYearTable."\">\n";
}
/*
********************************************************************************
...
return "<table width='100%' class=\"".$this->cssMonthTable."\">\n";
}
/*
********************************************************************************
...
//$linkstr=$this->mkUrl($this->actyear,$this->actmonth,$var);
 $linkstr="<a href=\"javascript:ShowAddLeaveForm".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var.")\">".$var."</a>";
