...
<tr bgcolor="#FFFFFF">
<td valign="top" colspan="2"><input type="button" id="submit_btn" name="save" value="Submit" onclick="MarkedAbsent()" /> <input type="button"  onclick="ShowStaffAllRequestedLeave()" value="Close" /></td>
</tr>
