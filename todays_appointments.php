...
<body bgcolor="#CCCCCC">
											<table bgcolor=#666666 border=0 cellpadding=0 cellspacing=1 width="100%">
												...
												$c = mysql_query("SELECT id, date_start, subject, location, start_minute, start_hour, description FROM tb_appointment WHERE user_id='$agent_no' AND date_start='$d' ORDER BY start_hour");	
															...
															<td valign="top">
																<table width=100% cellspacing=1 border=0 cellpadding=7 bgcolor=#fefefe>
																	<tr>
																		...
																		<td bgcolor=#FFFFFF valign="top" align="right"><i><?php echo $h; ?>:<?php echo $row["start_minute"]; ?>&nbsp;<?php echo $temp; ?></i></td>									
																</table>
															</td>
														</tr>
								<?php
