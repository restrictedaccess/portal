<?php /* Smarty version 2.6.19, created on 2011-03-01 22:24:26
...
<body>
<form method="post" name="form" action="?ran=<?php echo $this->_tpl_vars['random_string']; ?>
" accept-charset = "utf-8">
<input type="hidden" name="ran" id="ran"  value="<?php echo $this->_tpl_vars['random_string']; ?>
" />

<center><img src="../images/remote-staff-logo2.jpg" alt="think" ></center>
<table align="center" width="400" cellspacing="3">

<tr>
<td align="right" width="64">Email</td>
<td width="424"><input type="text" name="email" id="email"  size="40" /></td>
</tr>
...
<?php if ($this->_tpl_vars['status'] == False): ?>
<tr><td colspan="2" style="color:#FF0000; font-weight:bold; text-align:center; " ><?php echo $this->_tpl_vars['error_msg']; ?>
</td></tr>
<?php endif; ?>

<tr><td colspan="2"><INPUT type="submit" value="Login" name="show" >
</td></tr>


<tr>
<td colspan="2" align="left">* Retrieve Password, <a href="javascript:popup_win('../forgotpass.php?user=client', 580, 380 )">click here</a></td>
</tr>
</table>
