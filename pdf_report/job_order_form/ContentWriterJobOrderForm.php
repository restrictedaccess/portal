	...
	<div style="border:#999999 solid 1px; width:900px; float:left; margin-left:5px;">
		<div style=" line-height:20px; background:#CCCCCC; border:#CCCCCC outset 1px;"><b>
			...
			<div style="float:left; width:94px; border-left:#999999 solid 1px; ">
				...
				<div style="float:right;"><input type="button" value="add" style="font:10px tahoma; width:30px;" onclick="show_hide('technical_and_non_technical_add_form');" />
				</div>
				<div style="clear:both;"></div>	
			</div>
			<div style="clear:both;"></div>
		...
		<div id="technical_and_non_technical_add_form" style="border:#000000 solid 1px; padding:3px; display:none;">
			<input type="text" id="technical_and_non_technical_skill" name="technical_and_non_technical_skill" class="select" style="width:750px;"  />
			<select id="technical_and_non_technical_skill_rating" name="technical_and_non_technical_skill_rating" style="font:12px tahoma; width:40px;"  >
				<option value="">--</option>
			...
			<input type="button" value="save" style="font:11px tahoma; width:40px;" onclick="saveTechnicalAndNonTechnicalSkills(801);" />
			<input type="button" value="cancel" style="font:11px tahoma; width:40px;" onclick="hide('technical_and_non_technical_add_form');" />
		</div>
		<div id="technical_and_non_technical">
			<?
			$query = "SELECT job_order_details_id, job_requirement, rating FROM job_order_details j WHERE job_order_id = $job_order_id AND job_order_form_id = $job_order_form_id  AND groupings = 'technical_and_non_technical';";
				...
				?>
					<div style=" line-height:20px;  border-bottom:#CCCCCC solid 1px;">
						...
						<div style="float:left; width:94px; border-left:#999999 solid 1px; text-align:center;">
							<div style="float:left">&nbsp;&nbsp;<?=$rating;?></div>
							<div style="float:right"><a href="javascript:deleteJobOrderDetails(<?=$job_order_details_id;?>,'technical_and_non_technical',801,<?=$job_order_form_id;?>);">X</a>&nbsp;&nbsp;</div>
						</div>
						<div style="clear:both;"></div>
					</div>
			<?
