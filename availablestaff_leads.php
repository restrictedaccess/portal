...
if($lead_status!=""){
	...
	$lead_status = " AND l.status = 'Interview Bookings' ";
	$folder = "Interview Bookings"; 
}
...
function goto(id) 
{
	location.href = "apply_action2.php?id="+id+"&tab=Interview Bookings";
}
function check_val()
{
...
<p><label><b>Move :</b></label> <input type="submit" name="move" value="Follow Up" /> <input type="submit" name="move2" value="Keep in Touch" /> <input type="submit" name="move3" value="Pending" /></p>
