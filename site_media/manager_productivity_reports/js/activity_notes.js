...
var activityNotesRPC2 = "/portal/django/client_manager_scm/jsonrpc/";
...
jQuery(document).on("click", ".send_selected_staff", function(e){
	var userid = jQuery("#subcon_userid option:selected").attr("data-subcon_id");
    console.log(userid);	
	if (!userid){
