...
class activeCalendar{
	...
	*/
	function mkUrl($year,$month=false,$day=false){		session_start();		$view_type = $_SESSION["view_type"];		if (isset($_SESSION["view_type"])){			$view_type = "other_admin";			$selected_admin = $_SESSION["selected_admin"];		}else{			$view_type = "view";			$selected_admin = "";		}								
		...
		$yearNavLink="<a href=\"".$this->urlNav.$glueNav.$this->yearID."=".$year."&view_type={$view_type}&selected_admin={$selected_admin}\">";
		$monthNavLink="<a href=\"".$this->urlNav.$glueNav.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&view_type={$view_type}&selected_admin={$selected_admin}\">";
		$dayLink="<a href=\"".$this->url.$glue.$this->yearID."=".$year."&amp;".$this->monthID."=".$month."&amp;".$this->dayID."=".$day."&view_type={$view_type}&selected_admin={$selected_admin}\">".$day."</a>";
