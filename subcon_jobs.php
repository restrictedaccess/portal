...
<ul class="glossymenu">
 <li ><a href="subconHome.php"><b>Home</b></a></li>
  ...
  <li><a href="subcon_myapplications.php"><b>Applications</b></a></li>
   <li class="current"><a href="subcon_jobs.php"><b>Search Jobs</b></a></li>
</ul>
...
?>
		<tr bgcolor=<? echo $bgcolor;?>>
		  ...
		  <td width='34%' align=left><font size='1'> <a href="javascript:popup_win('./Ad.php?id=<? echo $id;?>',800,800);" class='t3'><?php echo stripslashes($position);?></a></font></td>
