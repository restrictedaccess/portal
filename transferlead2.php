...
$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND fname like '$fname' ORDER BY fname ASC;";
...
$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND lname like '$lname' ORDER BY fname ASC;";

//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND lname like '$lname' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND fname ='$fname' AND lname ='$lname' ORDER BY fname ASC;";

$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND fname ='$fname' AND lname ='$lname' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND company_name like '$companyname' ORDER BY fname ASC;";

$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND company_name like '$companyname' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND tracking_no LIKE '$promotional_code%' ORDER BY fname ASC;";

$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND tracking_no LIKE '$promotional_code%' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND company_address like '$companyaddress%' ORDER BY fname ASC;";

$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND company_address like '$companyaddress%' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND email = '$email' ORDER BY fname ASC;";

$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND email = '$email' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' AND mobile = '$mobile' ORDER BY fname ASC;";
$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no AND mobile = '$mobile' ORDER BY fname ASC;";
...
//$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
//FROM leads l
//WHERE status = 'Contacted Lead' AND SUBSTRING(l.tracking_no,1,$length)='$agent_code' ORDER BY fname ASC;";
$query="SELECT id,tracking_no,DATE_FORMAT(timestamp,'%D %M %Y'),remote_staff_needed,lname,fname,company_position,company_name,email,company_turnover ,rating
FROM leads l
WHERE status = 'Contacted Lead' AND agent_id =$agent_no ORDER BY fname ASC;";
...
if(isset($_POST['transfer']))
{
	...
	for ($i=0; $i<count($users);$i++)
	{
		...
		echo("<html><head><script>function update(){top.location='transferlead2.php';}var refresh=setInterval('update()',1500);
...
<html>
<head>
<title>Transfer Contacted Lead</title>
...
<form name="form" method="post" action="transferlead2.php" >
...
<ul class="glossymenu">
  ...
  <li class="current"><a href="contactedleads.php"><b>Contacted Leads</b></a></li>
...
<tr><td><br>
<b>Contacted Lead List</b><br>
<br></td></tr>

<tr><td><div class="animatedtabs" style="margin-bottom:1px; margin-top:5px; height:30px; border-bottom:none; float:left; width:600px;">
  <ul>
    <li ><a href="contactedleads.php" style="border-bottom:#CCCCCC solid 1px;"><span>Contacted Lead List</span></a></li>
    <li ><a href="addnewlead.php" style="border-bottom:#CCCCCC solid 1px;"><span>Add New Lead</span></a></li>
	 <li class="selected"><a href="transferlead2.php" style="border-bottom:#CCCCCC solid 1px;"><span>Business Partner Transfer Lead</span></a></li>
  </ul>
</div>
...
<tr bgcolor='#666666'>
<td width='6%' align=left><b><font size='1' color='#FFFFFF'>#</font></b></td>
<td width='12%' align=left><b><font size='1' color='#FFFFFF'>Name</font></b></td>
...
?>
		<tr bgcolor=<? echo $bgcolor;?>>
			  <td width='6%' align=left><font size='1'><? echo $counter.")";?>
			   ...
			   <input type="checkbox" onClick="check_val()" name="users" value="<? echo $id;?>" >
			    ...
			    <td width='12%' align=left><font size='1'><a href='#'onClick=javascript:popup_win('./viewLead.php?id=<? echo $id;?>',600,600);>
			  <? echo $fname." ".$lname;?>			  </a>
			  </font></td>
