...
/*id, leads_id, agent_id, userid, posting_id, date_contracted, client_price, aud_monthly, aud_weekly, aud_daily, aud_hourly, working_hours, working_days, php_monthly, php_weekly, php_daily, php_hourly, details, agent_commission, think_commission, overtime, company_contract_monthly, company_contract_weekly, company_contract_daily, company_contract_hourly, work_status, others, tax

$query="SELECT u.userid, u.fname, u.lname,DATE_FORMAT(s.date_contracted,'%D %M %Y'),u.nationality,u.email,u.skype_id,yahoo_id,image
		FROM personal u 
		JOIN subcontractors s ON s.userid = u.userid
		WHERE s.id = $sid AND s.userid =$userid;";
//echo $query;
$result=mysql_query($query);
list($userid, $fname, $lname,$date,$nationality,$email,$skype,$yahoo,$image) = mysql_fetch_array($result);
*/
$query="SELECT u.userid, u.fname, u.lname,DATE_FORMAT(a.date_apply,'%D %M %Y'),u.nationality,
u.email,u.skype_id,image,
l.fname,l.lname,starting_date
...
//echo $query;
$result=mysql_query($query);
list($userid,$fname,$lname,$date,$nationality,$email,$skype,$image,$lead_fname,$lead_lname,$starting_date) = mysql_fetch_array($result);
...
function setSalary()
{
	...
	var Php_Hourly =parseFloat(Php_Daily) / parseFloat(hour); // 9 working hours
...
<form name='form' action='editcontractphp.php' method='post' onSubmit="return checkFields();">
...
<table width='98%' cellpadding='5' cellspacing='0' style='border:#CCCCCC solid 1px;' align="center">
	<tr><td width='32%' valign='top' style='border-right:#CCCCCC solid 1px;'>
	<table width='100%'>
	<tr>
	<td width='39%'><strong><font size='1'>Date Sub-Contracted</font></strong></td>
	<td width='5%'><strong>:</strong></td>
	<td width='56%'><font size='1'><? echo $date;?></font></td>
	</tr>
	<tr>
	<td width='39%'><strong><font size='1'>Nationality</font></strong></td>
	<td width='5%'><strong>:</strong></td>
	<td width='56%'><font size='1'><? echo $nationality;?></font></td>
	</tr>
	<tr>
	<td width='39%'><strong><font size='1'>Email</font></strong></td>
	<td width='5%'><strong>:</strong></td>
	<td width='56%'><? echo $email;?></td>
	</tr>
	<tr>
	<td width='39%'><strong><font size='1'>Skype ID</font></strong></td>
	<td width='5%'><strong>:</strong></td>
	<td width='56%'><font size='1'><? echo $skype;?></font></td>
	</tr>
	
	<tr>
	<td height="313" colspan='3' align="center" valign="top"><br>
...
<font color='#999999' size='1'>(Australian Dollar)</font></font></strong></td>
	...
	<tr>
	<td width='57%' height="626" valign='top' style="border-right:#CCCCCC solid 1px;"><table width='99%'>
	<tr>
...
<font color='#999999' size='1'>(Australian Dollar)</font></td>
	...
	<td width='54%' valign="top"><input type='text' name='days'  id='days' style='color:#666666; width:20px;' value='5' class='text' >
	<!--  onkeyup='setSalary(); setSalary2();'-->
	...
	<td width='4%'><strong>:</strong></td>
	<td width='54%'><select name="lunch_start" id="lunch_start"  onChange="setHour2();" class="text">
	 <option value="">-</option>
      <option value="6">6:00 am</option>
      <option value="7">7:00 am</option>
      <option value="8">8:00 am</option>
	...
	<td width='4%'><strong>:</strong></td>
	<td width='54%'><select name="lunch_end" id="lunch_end" class="text" onChange="setHour2();" >
	<option value="">-</option>
      <option value="6">6:00 am</option>
      <option value="7">7:00 am</option>
      <option value="8">8:00 am</option>
	...
	<td width='4%'><strong>:</strong></td>
	<td width='54%'><input type='text' name='lunch_hour' id='lunch_hour' style='color:#666666;width:40px;' value="1" class='text'/> </td>
	</tr>
	<tr>
	<td align='right'><strong><font size='1'>Starting Date</font></strong></td>
	<td width='4%'><strong>:</strong></td>
	<td width='54%'><input type='text' id="starting_date" name='starting_date' style='color:#666666;' class='text' value="<? echo $starting_date;?>" >&nbsp;<img align="absmiddle" src="images/calendar_ico.png"   id="bd" style="cursor: pointer; " title="Date selector" onMouseOver="this.style.background='red'" onMouseOut="this.style.background=''" />
	 <script type="text/javascript">
                    Calendar.setup({
	...
	<input type='submit' name='process' id='process' value='Update'>
	<input type="button" name="Back" id="Back"  value="Back" onClick="self.location='adminscm.php'"/></td>
	</tr>
	</table></td>
	...
	<td width='43%' valign='top'><table width='100%' style="margin-left:8px;">
      ...
      <tr>
        <td width='37%'><strong><font size='1'>Salary per Week </font></strong><br />
            <font color='#999999' size='1'>(Philippine Pesos)</font></td>
        <td width='3%'><strong>:</strong></td>
        <td width='60%'><div id='week_label2'></div>
      ...
      <tr>
        <td width='37%'><strong><font size='1'>Salary per Day </font></strong><br />
            <font color='#999999' size='1'>(Philippine Pesos)</font></td>
        <td width='3%'><strong>:</strong></td>
        <td width='60%'><div id='day_label2'></div>
            <input type='hidden' name='salary_day2' id='salary_day2' style='color:#666666;' class='text'  /></td>
      </tr>
      <tr>
        <td width='37%' height="91"><strong><font size='1'>Hourly rate</font></strong><br />
            <font color='#999999' size='1'>(Philippine Pesos)</font></td>
        <td width='3%'><strong>:</strong></td>
        <td width='60%'><div id='hour_label2' style='color:#0000FF; font-weight:bold'></div>
      ...
      <tr>
        <td width='37%' colspan='3'><br>
            ...
            <a href="http://www.xe.com/ucc/" target="_blank" class="link10">Check Currency</a><br>
