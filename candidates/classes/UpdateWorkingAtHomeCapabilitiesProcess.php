...
/**
 * 
 * Class responsible for updating working at home capabilities
 *
...
class UpdateWorkingAtHomeCapabilities extends AbstractProcess{
	public function process(){
		...
		if (isset($_POST["process"])){
			...
			echo "<script>alert('Profile has been updated');window.close();</script>";
	...
	public function render(){
		...
		$operating_systems = array("Windows XP" , "Windows Vista" ,"Windows 7" , "Windows 8", "Linux", "Mac");
