...
class UpdateCandidateProfileForm extends Zend_Form{
	public function init(){
		...
		$referred_by = new Zend_Form_Element_Text("referred_by");
		$referred_by->class = "span4";
