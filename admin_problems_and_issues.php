    ...
    class SubconStatus extends TimeRecording {
        ...
        */
		...
		//echo $sql;
			...
			while(list($lead_id,$l_fname,$l_lname,$starting_hours, $ending_hours)=mysql_fetch_array($result))
										...
										<table width="100%">							
											<tr >
												<td colspan=3 valign="top" >
														<iframe id="frame" name="frame" width="100%" height="500" src="notes_list.php" frameborder="0">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
												</td>	
											</tr>
										</table>			
