...
if (isset($_POST['Ok'])) { // Check if the form has been submitted.
	...
	echo("<html><head><script>function update(){top.location='resumeShow.php?userid=$userid';}var refresh=setInterval('update()',1500);
...
<table width='650' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor="666666">
  ...
  <tr>
    <td><table width="625" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr><td ><img src="images/remote-staff-logo2.jpg" alt="think" width="607" height="81"></td>
      </tr>
    </table></td>
  </tr>
...
<table width="620" height="244" border="0" align="center" cellpadding="10" cellspacing="2"bgcolor="#FFFFFF">
  ...
  ?>
	...
	<!--
	<p align="center" style="margin-bottom:5px; margin-top:5px; border:#CCCCCC solid 1px; width:580px;">
	<b>
	...
	<form name="form" method="post" action="resumeShow.php" onSubmit="return checkFields();">
...
<table width="100%">
<tr>
<td width="30%"><img src="http://<?php echo $host;?>/portal/tools/staff_image.php?w=128&id=<?php echo $userid;?>" /></td>
<td width="70%" class="subtitle" valign="top"><? echo $name;?><br>
<? echo $latest_job_title;?></td>
</tr>
</table>
...
<td valign="top" width="75%"><? echo $company;?></td></tr>
<tr>
<td valign="top"></td>
...
<td valign="top" width="20%"><b>Company Name</b></td>
<td valign="top" width="1%">:</td>
<td valign="top" width="75%"><? echo $company2;?></td></tr>
<tr>
<td valign="top"></td>
<td valign="top"><b>Position Title</b></td><td valign="top">:</td>
...
<td valign="top" width="20%"><b>Company Name</b></td>
<td valign="top" width="1%">:</td>
<td valign="top" width="75%"><? echo $company3;?></td></tr>
<tr>
<td valign="top"></td>
<td valign="top"><b>Position Title</b></td><td valign="top">:</td>
...
<td valign="top" width="20%"><b>Company Name</b></td>
<td valign="top" width="1%">:</td>
<td valign="top" width="75%"><? echo $company4;?></td></tr>
<tr>
<td valign="top"></td>
<td valign="top"><b>Position Title</b></td><td valign="top">:</td>
...
<td valign="top" width="20%"><b>Company Name</b></td>
<td valign="top" width="1%">:</td>
<td valign="top" width="75%"><? echo $company5;?></td></tr>
<tr>
<td valign="top"></td>
<td valign="top"><b>Position Title</b></td><td valign="top">:</td>
...
$counter = 0;
$query5="SELECT id, agent_no, userid, rate, comments, DATE_FORMAT(date_created,'%D %M %Y') FROM comments WHERE userid=$userid AND agent_no=$agent_no ORDER BY date_created DESC;";
//echo $query;
