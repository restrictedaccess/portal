<div class="character_reference">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea name="contact_details[]" rows="8" class="span12 contact_details"></textarea>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">Contact Number</label>
		<div class="controls">
			<input type="text" class="span6 contact_number" name="contact_number[]"/>
		</div>
	</div>
	<div class="control-group" style="margin-bottom:3em">
		<label class="control-label">Email Address</label>
		<div class="controls">
			<input type="text" class="span6 character_email_address email_address" name="email_address[]"/>
		</div>
	</div>
</div>
