...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="/portal/application_form/css/style.css" type="text/css" rel="stylesheet"  />
		<link href="/portal/application_form/css/rsscroll.css" type="text/css" rel="stylesheet" />
		<style>
		{literal}
			.sub-bg{
			...
			#header{ height:113px; width:969px; overflow: hidden; /*width:920px 5-27-13 msl;*/}
			#headerleft{ width:680px; float:left;  }
			#headerright{ width:239px; float:right; text-align:right; font:11px tahoma !important; }
			#headerright p { margin:0; color:#55707e; font-weight:bold; }
			#headspacer{ height:#20px; line-height:20px; clear:both;}
			body#homex a#homenav, body#aboutusx a#aboutnav, body#registernow a#registernownav, body#jobopen a#jobopennav, body#howwork a#hownav,  body#showstaff a#showcasenav, body#testimonial a#testimonialnav, body#qanda a#qnanav, body#qualities a#qualitiesnav, body#loginx a#loginnav { background:url(images/remote-staff-nav-bg2.jpg) top left repeat-x;}
			#nav ul li a:hover{ background:url(images/remote-staff-nav-bg2.jpg) top left repeat-x;}
		{/literal}
		</style>
	</head>
	<body class="sub-bg" id="registernow">
		...
		<div id="container" >
			...
			<div id="contents" style="padding-bottom:230px" >
				
				<h3>Thank you for Responding</h3>
				
				<p>Thank you for responding. If you wish to reconsider your decision, please contact us by dialing 09479959825 or sending an email to <a href='mailto:recruitment@remotestaff.com.au'>recruitment@remotestaff.com.au</a></p>
			</div>
