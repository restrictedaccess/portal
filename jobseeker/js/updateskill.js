jQuery(document).ready(function(){
	...
	jQuery("#skill-form").validate({
		...
		submitHandler: function(form) {
			...
			jQuery.post("/portal/jobseeker/addskill.php", formData, function(data){
				...
				if (data.success){
					...
					template+="<td>";
					template+="<a href='/portal/jobseeker/edit_skill.php?id="+data.skill.id+"' class='edit_skill'>Edit</a> | ";
					template+="<a href='/portal/jobseeker/delete_skill.php?id="+data.skill.id+"' class='delete_skill'>Delete</a>";
	...
	jQuery(".delete_skill").live("click", function(e){
		var me = jQuery(this);
		var answer = confirm("Do you want to delete this skill?")
		if (answer){
