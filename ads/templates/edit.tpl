<form name="form" method="post" action="./update/" onsubmit="return CheckCreatedAds()" >
	...
	<table align="center" width="80%" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:20px;">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td align="left">
			<input type="text" name="companyname" id="companyname" value="{$ad.companyname|escape}" size="50">
			</td>
		</tr>
		...
		<tr bgcolor="#FFFFFF">
			...
			<td align="left" >
			<input type="text" name="jobposition" id="jobposition" value="{$ad.jobposition}" size="50">
			</td>
		</tr>
		...
		<tr bgcolor="#FFFFFF">
			...
			<td align="left">
			<input type="text" readonly="readonly" name="jobvacancy_no" id="jobvacancy_no" value="{$ad.jobvacancy_no}" size="3">
			</td>
		</tr>

		<tr bgcolor="#FFFFFF">
			<td align="left">Heading</td>
			<td align="left">			<textarea name="heading" id="heading" wrap="physical" style="width:99%; height:200px;">{$ad.heading}</textarea></td>
		</tr>
		...
		<tr bgcolor="#FFFFFF">
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2">
				...
				<tr class="row_to_clone">
					...
					<input readonly="readonly" name="responsibility[{$ctr}]" type="text" class="text" style="width:100%;" value="{$responsibilities[j].responsibility}"  />
					</td>
				</tr>
		...
		<tr bgcolor="#FFFFFF">
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2">
				...
				<tr class="row_to_clone2">
					<td width="2%" align="right"><img src="../images/box.gif"></td>
					<td width="98%" align="left">
					<input readonly="readonly" name="requirement[{$ctr}]" type="text" class="text" style="width:100%;" value="{$requirements[j].requirement}"  />
					</td>
				</tr>
				{assign var='ctr' value=$ctr+1}
				{sectionelse}
				<tr class="row_to_clone2">
					<td width="2%" align="right"><img src="../images/box.gif"></td>
					<td width="98%" align="left">
					<input readonly="readonly" name="requirement[0]" type="text" class="text" style="width:100%;"  />
					</td>
				</tr>
