...
<div><img src="images/remote-staff-logo2.jpg" alt="think" ></div>
<div id="left_pane" style="display:none;"></div>
...
<tr class="tr_w" >
	<td class="lbl" align="right">Created and Filled up by</td>
...
<tr class="tr_w" >
	<td colspan="2" ><span class="lbl">Consider an Indian applicant for this position :</span> {$indian_applicant|upper}</td>
</tr>
...
{/section}
<!--
<tr><td colspan="2" class="td_w">Recruitment Setup Fee payment (FREE)</td></tr>
<tr class="tr_w" >
