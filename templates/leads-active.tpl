...
<form name="form" method="post" enctype="multipart/form-data" action="leads-active.php?lead_status=Client&filter={$filter}"  >
...
<div id="per_info">
	<h2 {$active_h2}><a href="leads-active.php?lead_status=Client&filter=ACTIVE{if $keyword}&keyword={$keyword} {/if}">ACTIVE CLIENTS</a></h2>
	<h2 {$inactive_h2}><a href="leads-active.php?lead_status=Client&filter=INACTIVE{if $keyword}&keyword={$keyword} {/if}">INACTIVE CLIENTS</a></h2>
	<h2 {$all_h2}><a href="leads-active.php?lead_status=Client&filter=ALL{if $keyword}&keyword={$keyword} {/if}">ALL CLIENTS</a></h2>
	<br clear="all" />
</div>
