...
$sql = "SELECT DISTINCT(leads_id), fname, lname, email, company_address FROM subcontractors s LEFT JOIN leads l ON l.id = s.leads_id WHERE s.status IN ('ACTIVE', 'suspended') ORDER BY l.fname;";
