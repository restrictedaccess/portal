...
<div style="text-align:right;">
	<input type="button" value="Controls" onClick="showEvaluationForm();">&nbsp;
...
<table width='650' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor="666666">
  ...
  <tr>
    <td><table width="625" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr><td ><img src="images/banner/remoteStaff-416_108.jpg" alt="think" width="416" height="108"></td>
      </tr>
    </table></td>
  </tr>
...
<tr><td valign="top"><b>Skype</b></td><td valign="top">:</td><td width="37%" valign="top"><? echo $skype_id;?></td>
<td valign="top" colspan="3"> </td></tr>
