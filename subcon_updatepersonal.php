...
<br>
<form method="POST" name="frmPersonal" action="subcon_updatepersonalphp.php"onsubmit="return checkFields();">
...
<td><INPUT maxLength=100 size=30 style='width:270px' class="text" name="email" value="<? echo $email;?>" onChange="javascript: ValidateOneEmail(this);"></td></tr>
<tr valign=top><td align=right width=30% >Password :</td>
<td><?=$pass;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="#" title="Change Password" onClick= "javascript:popup_win('./subcon_changepassword.php?userid=<? echo $userid;?>',500,300);">Change Password</a></td></tr>
...
<textarea  rows="3"  style='width:270px' class="text" name="address1" id="address1"><?=$address1;?></textarea></td></tr>

<tr valign=top><td align=right width=30% valign=top >Address 2:</td><td><textarea  rows="3"  style='width:270px' class="text" name="address2" id="address2"><?=$address2;?></textarea></td></tr>
