...
<tr><td>
<form method="POST" name="frmSkills" action="subcon_updateskillsStrengthsphp.php" onSubmit="return checkFields();">
...
<tr><td align=center>
<INPUT type="submit" value='Save &amp; Add Another Skill' name="Add" id="Add" class="button" style="width:220px">&nbsp;&nbsp;
</td></tr>
<tr>
<td align="center">
<!-- skills list -->
...
<?
$counter = 0;
$query="SELECT id, skill, experience, proficiency FROM skills WHERE userid=$userid ORDER BY id DESC;";
//echo $query;
...
<!--
	function go(id) 
	{
			...
			if (confirm("Are you sure you want to delete this skill?")) {
				location.href = "deleteskill3.php?id="+id+"&userid="+<? echo $userid;?>;
				//alert(id);
			}
	}
