				...
				<div>
					<div class="col-lg-12 col-md-12 col-xs-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<ul>
									{foreach from=$writer_types item=writer_type}
										<li>{$writer_type.description}</li>
									{/foreach}
								</ul>
							</div>
						</div>
			...
			<div>
				<div class="col-lg-12 col-md-12 col-xs-12">
					...
					{if $telemarketer_flag}
						<p>Type of Campaign ? <strong>{$campaign_type}</strong></p>
						<p>Call Type ? <strong>{$call_type}</strong></p>
					{/if}
					
					{if $marketing_assistant_flag}
						<p>Do you need your staff to be on the phone ? <strong>{$staff_phone}</strong></p>
					{/if}
				</div>
			</div>
					...
					<div class="col-lg-12 col-md-12 col-xs-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<ol>
									<li>
										Is this an existing campaign ? <strong><u>{$q1}</u></strong>
										<br/>Do you have someone onshore or offshore calling out for you ? <strong><u>{$q2}</u></strong>
									</li>
									<li>Will you provide the lead or do you expect your telemarketer to do lead generation as well? <strong><u>{$lead_generation}</u></strong></li>
									<li>Is the telemarketer going to call your client database ? <strong><u>{$q3}</u></strong></li>
									<li>What is the goal at the end of each call ? <strong><u>{$q4}</u></strong></li>
									<li>How many contacts do you expect your telemarketer to make in 4 hours (part time) ? in 8 hours (full time) ? <strong><u>{$telemarketer_hrs}</u></strong></li>
