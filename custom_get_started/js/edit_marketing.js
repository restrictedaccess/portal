jQuery(document).ready(function(){
	...
	jQuery(".add-writer-type").on("click", function(e){
		var src = jQuery("#writer-row").html();
		jQuery(src).appendTo(jQuery("#writer-type-div"));
		e.preventDefault();
		e.stopPropagation();
	});
	...
	jQuery("#main-form").on("submit", function(){
		...
		jQuery.post("/portal/custom_get_started/update_marketing_js.php", data, function(response){
