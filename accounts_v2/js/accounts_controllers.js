...
function MainCtrl($scope, $http) {
    ...
    $scope.complianceTimesheetUrl = "";

    if(BASE_URL == "http://staging.remotestaff.com.au"){
        $scope.complianceTimesheetUrl = "http://staging.compliance.remotestaff.com.au/#/compliance/timesheet-notes";
    } else {
        $scope.complianceTimesheetUrl = "http://compliance.remotestaff.com.au/#/compliance/timesheet-notes";
    }
}
