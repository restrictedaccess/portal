...
if($amount==NULL or $amount==""){
	$query = "UPDATE set_up_fee_invoice_details SET description = '$description' WHERE id = $id;";
}else{
	$query = "UPDATE set_up_fee_invoice_details SET description = '$description', amount = $amount WHERE id = $id;";
}
//echo $query;
