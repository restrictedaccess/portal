        ...
        {strip}
            <div class="invoice_list" 
                ...
                invoice_date="{$draft_records[j].invoice_date}">
                    {$draft_records[j].invoice_date} Invoice # {$draft_records[j].id} {$draft_records[j].description|escape}
            </div>
        {/strip}
        {/section}
    </div>
        ...
        {strip}
            <div class="invoice_list" 
                ...
                invoice_date="{$approved_records[j].invoice_date}">
                    {$approved_records[j].invoice_date} Invoice # {$approved_records[j].id} {$approved_records[j].description|escape}
            </div>
        {/strip}
        {/section}
    </div>
        ...
        {strip}
            <div class="invoice_list" 
                ...
                invoice_date="{$posted_records[j].invoice_date}">
                    {$posted_records[j].invoice_date} Invoice # {$posted_records[j].id} {$posted_records[j].description|escape}
            </div>
        {/strip}
        {/section}
    </div>
