<?php
   include("../../conf.php");
    ...
    $query = "SELECT id, invoice_date, status, description, updated_by, updated_by_type, start_date, end_date, total_amount FROM agent_invoice where (status = 'draft' or status = 'posted' or status = 'approved') and invoice_date between '$start_date' and '$end_date' ORDER BY invoice_date";
	//echo $query;
