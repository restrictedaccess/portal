<?php
    ...
    $query = "SELECT id, invoice_date, status, description, payment_details, updated_by, updated_by_type, start_date, end_date, total_amount from subcon_invoice where userid = $userid and (status = 'draft' or status = 'posted' or status = 'approved') order by invoice_date";
