...
<div style="width: 80%;">
	...
	<div style="display:block;" >
		...
		<div style="float:left; margin-left:10PX; display:block; width:210px; color:#0033FF; " ><b>All Registered Applicants</b> (<?=$numrows;?>)</div>
	...
	&nbsp;<span class="ctrl_btn" title="Edit <?=$category_name;?>" onClick="editCategories('cat',<?=$category_id;?>)"><img src="../images/category/b_edit.png"></span>
		<?
				...
				$sql="SELECT sub_category_id, sub_category_name, classification FROM job_sub_category WHERE category_id = $category_id;";
				$data = 	mysql_query($sql);	
				while(list($sub_category_id, $sub_category_name, $classification)=mysql_fetch_array($data))
				{
					...
					?>
						<li><?=$sub_category_name;?>(<?=$count;?>) (<a href="javascript: editSubCat('<?=$sub_category_name;?>',<?php echo $sub_category_id; ?>,'<?php echo $classification; ?>'); ">Edit</a>)</li>						
					<?
				}
			?>
		</div>	
