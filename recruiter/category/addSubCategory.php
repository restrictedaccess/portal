...
$query = "INSERT INTO job_sub_category SET category_id = $category_id, sub_category_name = '$sub_category', classification = '$classification', sub_category_date_created = '$ATZ';";
...
while(list($sub_category_id, $sub_category_name, $classification)=mysql_fetch_array($data))
{
	?>
		<div style="padding:2px; border-bottom:#CCCCCC solid 1px;">
			<div style="float:left; width:390px; display:block;"><?=$sub_category_name;?> - <?=$classification; ?></div>
