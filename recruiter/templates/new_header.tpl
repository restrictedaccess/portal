...
<link rel="stylesheet" type="text/css" href="/portal/recruiter/css/new_header.css"/>
<nav id="main_bar" class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
			...
			{if $will_redirect_to_new_jobseeker_v2}
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Recruiter Search <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="/portal/recruiter_v2/#/recruiter/candidates">Candidates</a></li>
		...
		<form action="/portal/recruiter_search/recruiter_search.php" method="GET" class="navbar-form navbar-left">
			...
			<input type="text" class="form-control" id="full-text-search" placeholder="Search Candidate, Job Order, Leads" name="q">
			</div>
