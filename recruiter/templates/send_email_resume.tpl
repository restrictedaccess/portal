...
<script type="text/javascript" src="../js/category-management.js"></script>
</head>
...
<!--START: sub title-->
<h1 align="left">&nbsp;&nbsp;Send Email Resume</span> </h1>
<!--ENDED: sub title-->            
            

<!--START: listings-->
            <div align="center">
				<iframe id="frame" name="frame" width="100%" height="800" src="../admin_send_email_resume.php" frameborder="0" scrolling="yes">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
            </div>
