...
<script type="text/javascript" src="js/move_endorse_to_client.js"></script>
                              ...
                              <tr>
                                <td height="32" colspan="2" valign="middle">
                                  <table width="100%">
                                    ...
                                    <tr>    
                                      <td width="11%" height="28" valign="top">Job&nbsp;Position&nbsp;[<a href="javascript: show_job_position_report(); ">Refresh</a>]</td>
                                      <td width="1%" valign="top">:</td>
