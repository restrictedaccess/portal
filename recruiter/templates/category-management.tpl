...
<!--START: sub title-->
<h1 align="left">&nbsp;&nbsp;Category Management</span> </h1>
<!--ENDED: sub title-->            
            

<!--START: listings-->
            <div align="center">
				<iframe id="frame" name="frame" width="100%" height="800" src="../category-management.php" frameborder="0" scrolling="no">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
            </div>
