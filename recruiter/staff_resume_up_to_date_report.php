	...
	<tr>
    	<td>
            <table width="100%" cellpadding="3" cellspacing="3" border="0" bgcolor=#FFFFCC>
                <tr bgcolor="#FFFFFF">
                    <td width="100%" align="left" valign="top"><div class="hiresteps"><table width="100%"><tr><td><font color="#003366"><strong>Resume Update Summary</strong></font></td><td align="right"><a href='javascript: staff_resume_up_to_date_exit(); '><img src="../../portal/images/closelabel.gif" border="0" /></a></td></tr></table></div></td>
                </tr>
                <tr>
                    <td valign="top">
						<table width="100%" bgcolor="#FFFFCC" cellspacing="1" cellpadding="1">
							...
							$q ="SELECT ns.date, a.admin_fname, a.admin_lname FROM staff_resume_up_to_date ns, admin a WHERE a.admin_id = ns.admin_id AND ns.userid = '$userid' ORDER BY ns.date DESC";
