...
<a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/" target="_blank" class="link10" title="Outsourcing Online Staff from the Philippines"><?php echo strtoupper($_SERVER['HTTP_HOST']);?></a>
</td><td valign="top" align="right"><font size="1"><a href="../logout.php" class="link10">Agent/Client/Sub-Contractor login</a></font></td></tr>
