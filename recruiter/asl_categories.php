...
<body bgcolor='#FFFFFF' onLoad="javascript: showCategoriesAddForm(<?php echo $userid;?>); ">
...
-->
<div id="container" ><img src="../images/ajax-loader.gif"> Evaluation Form Loading...</div>
<!-- ends here -->
