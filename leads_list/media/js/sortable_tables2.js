...
update(SortableManager2.prototype, {

    "initWithTable": function (table) {
        /***

            Initialize the SortableManager2 with a table object
    ...
    "onSortClick": function (name) {
        ...
        ***/
        return method(this, function () {
			...
			if(name == 0 || name == 2 || name == 4 || name == 5){
...
sortableManager2 = new SortableManager2();
