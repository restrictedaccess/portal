...
FROM leads l
WHERE status = 'Client' AND agent_id =$agent_no ORDER BY timestamp DESC;";
}
//echo $query;
$counter = 0;
...
<div id="page_desc">
<p>Dear Affiliate, </p>
<p>Congratulations! Your lead has been converted to be RemoteStaff’s client.  </p>
<p>You have helped these people discover the unbeatable staffing solution! </p>
<p>You will get ongoing commission from this. For details about your commission please go to “Commission Payments” tab.  </p>
<p>Cheers, <br>
Team RemoteStaff
</p>
</div>
...
<div class="box_client_leads" >Client List
