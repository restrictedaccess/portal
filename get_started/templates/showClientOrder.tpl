...
<title>Recruitment Order</title>

<link rel=stylesheet type=text/css href="../css/font.css">
<link rel=stylesheet type=text/css href='media/css/get_started.css'>
<link rel=stylesheet type=text/css href='media/css/gs.css'>
...
{strip}
	...
	<td colspan="2">
		...
		<ul>
			...
			<li><a href="javascript:popup_win('./job_spec.php?gs_job_titles_details_id={$selected_job_titles[j].gs_job_titles_details_id}&jr_cat_id={$selected_job_titles[j].jr_cat_id}&jr_list_id={$selected_job_titles[j].jr_list_id}&gs_job_role_selection_id={$gs_job_role_selection_id}',950,600)">Job Specification Form</a>
