...
if($client_id==""){
	die("Error page cannot be viewed. Session expires please re-login");
}
...
//compare the leads_id and the client_id must be equal
if($leads_id != $client_id){
	die("Error page cannot be viewed.");
}
...
$smarty->display('showClientOrder.tpl');
