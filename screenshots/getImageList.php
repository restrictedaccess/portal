    ...
    */
    function GetLatestImageList($uid, $user_type) {
        ...
        for ($i = 0; $i < 24; $i++) {
            ...
            $query = "select post_time from screenshots where userid = $uid and user_type = '$user_type' and post_time >= '$date_time_start_str' and post_time < '$date_time_end_str' order by post_time";
