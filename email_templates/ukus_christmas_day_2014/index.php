...
if (TEST) { 
	$base = "http://devs.remotestaff.com.au/portal/email_templates/ukus_christmas_day_2014/";
} else if (STAGING) {
	$base = "http://staging.remotestaff.com.au/portal/email_templates/ukus_christmas_day_2014/";
} else {
	$base = "http://remotestaff.com.au/portal/email_templates/ukus_christmas_day_2014/";
}
?>
...
<div style="text-align:center;margin:0">
	<table border="0" height="1035" width="800" style="margin:auto;text-align:left;color:#000000">
		<tr>
			<td valign="top">
				<div>
					<img src="<?php echo $base?>images/header_top.png"/>
				</div>
				<div style="margin-top:-35px;padding-left:45px;padding-right:52px">
					...
					<p style="margin:0;margin-left:58px;margin-bottom:19px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000;text-align:left">December 24, Day before Christmas<br/>December 25, Christmas Day<br/>December 30, Rizal Day<br/>December 31, Last day of the year<br/>January 1, New Year's Day</p>
				<table style="margin:0;margin-bottom:19px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000;text-align:left">
				<tr>
					<td valign="top">
						<img src="<?php echo $base?>images/bullet.png"/>
					</td>
					<td valign="top">
						<p style="margin-top:4px;margin-bottom:0">The Client will provide the Remote Staff Service Provider with mandatory paid leave at regular hourly rate for the 5 days indicated above.</p>
					</td>
				</tr>
				<tr>
					<td valign="top">
					...
					<td valign="top">
						<p style="margin-top:4px;margin-bottom:0">The Remote Staff Service provider's hourly rate is at 200% in event where Remote Staff Service Provider is required to work during December 24, 25, 30, 31 and January 1.</p>
					</td>
				</tr>
				</table>
				<p style="margin:0;margin-bottom:19px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#597200;text-align:left">Reasons why this update has been applied:</p>
				<p style="margin:0;margin-bottom:19px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000;text-align:left">Remote Staff Inc. and most of our clients recognize the importance of the December month to the Filipino culture. Normally employees in the Philippines receive a 13th month pay in December, but Remote Staff contractors do not. It's been optional for Clients to contribute towards paid leaves since the company started, but last year Dec 2013 we had made efforts to add paid leaves with every client December invoice.</p>
