...
*/
$query ="INSERT INTO quote_notes SET quote_id = $quote_id, quote_details_id = $quote_details_id , created_by = $created_by, created_by_type = '$created_by_type', notes = '$message', date_note = '$ATZ';";
