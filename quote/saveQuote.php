...
//echo $created_by_type."<br>".$created_by;
...
if($gst == "with"){
	...
	if($currency == "POUND"){
		$gst = ((($quoted_price * $no_of_staff)/100) * 17.5);
	}
	if($currency == "USD"){
...
$query = "INSERT INTO quote_details SET 
			quote_id = $quote_id, 
			salary = $salary, 
...
{	
	...
	if($currency == "POUND"){
		$currency_txt = "Sub-Contractor Salary in United Kingdom GBP";
