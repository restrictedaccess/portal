...
if (isset($_POST['Ok'])) { // Check if the form has been submitted.
	...
	echo("<html><head><script>function update(){top.location='resumeShowFull.php?userid=$userid';}var refresh=setInterval('update()',1500);
...
<table width="620" height="244" border="0" align="center" cellpadding="10" cellspacing="2"bgcolor="#FFFFFF">
  ...
  ?>
	...
	<form name="form" method="post" action="resumeShowFull.php" onSubmit="return checkFields();">
