		...
		<tr>
			<td valign="top">
				...
				<?php
					if (TEST){
				?>	
					<img src="http://test.remotestaff.com.au/portal/images/queens_crown.png" alt="Queen's Bday Remote Staff Update"/>
				<?php }else{
				?>
					<img src="http://remotestaff.com.au/portal/images/queens_crown.png" alt="Queen's Bday Remote Staff Update"/>
				<?php
					}
				?>	
				</div>
				<p style="margin-top:34px;margin-bottom:29px;font-size:12pt;font-family:Arial, Helvetica, sans-serif;line-height:1.5em;text-align: center;word-spacing:3px">The Queen's Birthday is a public holiday celebrated in most states and<br/> territories (except for WA) on the second Monday in June, making for a<br/> much-looked-forward-to June long weekend.</p>
				<p style="margin-bottom:30px;margin-top:0;font-size:22pt;font-family:Arial, Helvetica, sans-serif;line-height:1.5em;text-align: center;color:#7B277C;font-weight: bold;word-spacing:3px">This year it falls on June 10th.</p>
				...
				<?php
					if (TEST){
				?>
				<p style="text-align: right;margin-top:0;margin-bottom:0"><img src="http://test.remotestaff.com.au/portal/images/rs_logo_queens.png"></p>
				<?php
					}else{
				?>
				<p style="text-align: right;margin-top:0;margin-bottom:0"><img src="http://remotestaff.com.au/portal/images/rs_logo_queens.png"></p>
				<?php
					}
				?>
