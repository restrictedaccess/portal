...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                <p class="navbar-text pull-right"><a href="/portal/whitelist/" >Admin Whitelist</a></p>
                <ul id="nav" class="nav">
    ...
    <h2 align="center">Whitelisted Admins</h2>
    
    <p align="center">
        <select name="admins" id="admins" style="margin-bottom:0px;">
	...
	<div id="results">
        ...
        <!--
		<table class="table table-condensed table-striped table-bordered" style="width:50% !important; margin:auto;">
			<tbody>
				<tr><td>Loading...</td></tr>
			</tbody>
		</table>
