...
$educationNames=array("High School Diploma","Vocational Diploma / Short Course Certificate","Bachelors/College Degree","Post Graduate Diploma / Master Degree","Professional License (Passed Board/Bar/Professional License Exam)","Doctorate Degree");
...
<form method="POST" name="edu" action="subcon_updateeducationphp.php"onsubmit="return checkFields();">
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="32">
				<tr><td width="736"  bgcolor="#abccdd" >
					<table width="736">
						<tr>
							<td style="font: 8pt verdana; "><b>Welcome, <? echo $name;?> this is your personal page</b></td>
