...
<tr bgcolor="#CCCCCC"><td colspan="5"><b>Personal Information</b></td><td align="right"><a href="subcon_updatepersonal.php?userid=<? echo $userid;?>">Edit</a></td></tr>
...
id, userid, educationallevel, fieldstudy, major, grade, gpascore, college_name, college_country, graduate_month, graduate_year, trainings_seminars
*/
...
{
	$row = mysql_fetch_array ($result); 
	$level = $row['educationallevel'];
	$field = $row['fieldstudy'];
	$score = $row['gpascore'];
	$major = $row['major'];
	$school =$row['college_name'];
	$loc  = $row['college_country'];
	$year =$row['graduate_year'];
	$month =$row['graduate_month'];
	$trainings_seminars = $row['trainings_seminars'];
	switch($month)
	{
		case 1:
		$month= "Jan";
...
?>
<tr bgcolor="#CCCCCC"><td valign="top" colspan="5" class="ResumeHdr"><b>Highest Qualification</b></td><td align="right"><a href="subcon_updateeducation.php?userid=<? echo $userid;?>">Edit</a></td></tr>
...
?>
<tr bgcolor="#CCCCCC"><td valign="top" colspan="5" class="ResumeHdr"><b>Training and Seminars Attended</b></td><td align="right"><a href="subcon_updateeducation.php?userid=<? echo $userid;?>">Edit</a></td></tr>
<tr><td valign="top" colspan="6">
<?=str_replace("\n","<br>",$trainings_seminars);?>

</td></tr><tr class="TRHeader">
<!--- work Experience --->
<?
$query="SELECT * FROM currentjob WHERE userid=$userid";
$result=mysql_query($query);
...
<tr bgcolor="#CCCCCC">
<td valign="top" colspan="5" class="ResumeHdr"><b>Employment History</b></td><td align="right"><a href="subcon_updatecurrentJob.php?userid=<? echo $userid;?>">Edit</a></td>
</tr>
<tr><td valign="top" colspan="6">
...
?>
<!--- languages --->
<tr bgcolor="#CCCCCC"><td valign="top" colspan="5" ><b>Languages</b></td><td align="right"><a href="subcon_updatelanguages.php">Edit</a></td></tr>
<tr><td valign="top" colspan="6">
...
<tr bgcolor="#CCCCCC"><td valign="top" colspan="5" ><b>Skills</b></td><td align="right"><a href="subcon_updateskillsStrengths.php?userid=<? echo $userid;?>">Edit</a></td></tr>
<tr><td valign="top" colspan="6">
