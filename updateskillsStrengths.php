...
<tr><td>
<form method="POST" name="frmSkills" action="updateskillsStrengthsphp.php" onSubmit="return checkFields();">
...
<!--
	function go(id) 
	{
			...
			if (confirm("Are you sure you want to delete this skill?")) {
				location.href = "deleteskill2.php?id="+id+"&userid="+<? echo $userid;?>;
				//alert(id);
			}
	}
