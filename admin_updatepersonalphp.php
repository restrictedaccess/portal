...
$english_communication_skill = $_REQUEST["english_communication_skill"];
...
else
{
	...
	staff_history($db, $userid, $_SESSION['admin_id'], 'ADMIN', 'PROFILE', 'UPDATE', '');
