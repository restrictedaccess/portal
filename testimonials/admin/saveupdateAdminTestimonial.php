...
$admin_testimony = filterfield($_REQUEST['admin_testimony']);
...
if($testimony_id > 0 ){
	$query = "UPDATE testimonials SET 
					date_updated = '$ATZ',
					testimony = '$admin_testimony'
					WHERE testimony_id = $testimony_id;";
	$result = mysql_query($query);		
	if(!$result) die ("Error in Script : <br>".$query);
	echo "<div style='padding:5px;background:yellow;color:black;text-align:center;'><b>Testimony Updated!</b></div>";
