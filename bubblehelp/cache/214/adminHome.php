...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=mike.lacanilao@remotestaff.com.au&hash=t34a5a43bccd0597ff',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  class='hlink' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink" title="Login in Different Account">Login</a>
...
<td valign="top">
<div align="right">Welcome #214 Michael ..</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=mike.lacanilao@remotestaff.com.au&hash=de7ed5df4dbac23ed0',800,600);
			}
			return false;
		}
