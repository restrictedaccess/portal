...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=remote.leopoldo@gmail.com&hash=r9b46b808eb54e84b2',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  style='text-decoration:none;color:#666666;' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  style="text-decoration:none;color:#666666;">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" style="text-decoration:none;color:#666666;" title="Login in Different Account">Login</a>
	| <a href="/portal/bubblehelp/bhelp.php?/create_page/&curl=adminHome.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" style="text-decoration:none;color:#666666;" title="Open Help Page" >Help Page</a>
| <a href="#" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" onmouseover="showReportMenu(this)" onmouseout="mclosetime()" style="text-decoration:none;color:#666666;">Bug Report</a></div>
...
<td valign="top">
<div align="right">Welcome #109 Leopoldo Suquib</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=remote.leopoldo@gmail.com&hash=cffb40d008d4569ad6',800,600);
			}
			return false;
		}
