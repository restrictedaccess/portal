...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=michelleb@remotestaff.com.au&hash=y951fd04512b40d7d6',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  style='text-decoration:none;color:#666666;' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  style="text-decoration:none;color:#666666;">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" style="text-decoration:none;color:#666666;" title="Login in Different Account">Login</a>
...
<td valign="top">
<div align="right">Welcome #83 Michelle Borras</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=michelleb@remotestaff.com.au&hash=w70c10952444b05a64',800,600);
			}
			return false;
		}
