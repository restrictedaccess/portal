...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=veronica@remotestaff.com.au&hash=kcc5da82cb88d48dc0',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  class='hlink' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink" title="Login in Different Account">Login</a>
...
INVOICING[12]='<a href="/portal/soa/" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" target="blank">Statement Of Account</a>'
// TOOLS
var TOOLS=new Array() 
...
<td valign="top">
<div align="right">Welcome #233 Veronica    Chen</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=veronica@remotestaff.com.au&hash=v8211e8a1f80ae8e10',800,600);
			}
			return false;
		}
