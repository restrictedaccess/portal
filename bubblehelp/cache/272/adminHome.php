...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=riokaterin@remotestaff.com.au&hash=md3076573126f40cee',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  class='hlink' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink" title="Login in Different Account">Login</a>
...
<td valign="top">
<div align="right">Welcome #272 Rio Katerin Lavarias</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=riokaterin@remotestaff.com.au&hash=aa8f968fc01cf3c272',800,600);
			}
			return false;
		}
