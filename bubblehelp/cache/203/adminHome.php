...
<a href="javascript:popup_win8('.\/rschat.php?portal=1&email=jernalyn@remotestaff.com.ph&hash=pf450f135b2be52beb',800,600);" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  class='hlink' title='Open remostaff chat'>Chat</a> | 	<a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink">Logout</a> | <a href="logout.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" class="hlink" title="Login in Different Account">Login</a>
...
<ul>
	...
	<li><a href="adminHome.php' id='homenav' " style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Home</a></li>
	...
	<li><a href="leads-active.php?lead_status=Client&filter=ACTIVE" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;"  >Clients </a></li>
...
<li><a href="admin_job_order.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Job Request/Order Form</a></li>
<li><a href="admin_newsletter_tips.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Newsletter &amp; Tips</a></li>
<li><a href="admin_comments_suggestion.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Comments &amp; Suggestions</a></li>  
<li><a href="admin_subcon_updates.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Bulletin Board</a></li>
<li><a href="/portal/invoice/StaffInvoiceMaintenance/StaffInvoiceMaintenance.html" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;" >Invoicing for Sub-Con</a></li>	
<li><a href="admin_subcon_payment_details.php" style="cursor:pointer" onclick="return bubbletip.show(this);" onmouseout="bubbletip.hide();" oncontextmenu="showContextMenu(this);return false;">Sub-Con Payment Details</a></li>
...
<td valign="top">
<div align="right">Welcome #203 Jernalyn Malonzo</div>
...
<script language="javascript">
		...
		function void(clicked) {
			...
			if (clicked == 1) {
				popup_win8('./rschat.php?portal=1&email=jernalyn@remotestaff.com.ph&hash=n9ae62dddbfa923f94',800,600);
			}
			return false;
		}
