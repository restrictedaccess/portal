...
<html class="no-js" lang="">
	...
	<head>
		...
		<!-- Bootstrap Core CSS -->
		<link rel="canonical" href="https://remotestaff.com.au/portal/link_form/thank_you.php">
...
<!-- Bootstrap Core CSS -->
    ...
    <noscript>
        ...
        <link href="css/thank_you.css" rel="stylesheet" type="text/css"/>
	...
	<body>
		<!-- Google Code for Lead : Recruitment briefing form Conversion Page -->
		{include file = "tracking_codes.tpl"}
        ...
        {/php}
			...
			<div class="color-fade">
					...
					{include file = "thank_you_fold1.tpl"}
					</div>
				<div class="mobile-view-header">
