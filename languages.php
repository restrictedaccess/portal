...
<!-- header --><table cellpadding="0" cellspacing="0" border="0" width="744">
...
<li style="margin-bottom:10px;"><b style="color:#0000FF">Languages Details </b><img src="images/arrow.gif"></li>
...
<tr><td>
<form method="POST" name="frmLang" action="languagesphp.php"  onsubmit="">
