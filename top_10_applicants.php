...
if($_SESSION['admin_id']=="")
{
	...
	{
		$id = @$_GET["id"];
		$a = "UPDATE job_sub_category_applicants SET ratings ='1' WHERE id='$id'";
		$r_e = mysql_query($a);		
	}
                        ...
                        <td align="left" valign="top" bgcolor="#ffffff" colspan="4> <font color="#000000"><strong>
                          <form action="" method="post" name="formtable" onSubmit="if (this.report_t.value =='') return false;">
							...
							<td>	  
                                ...
                                <td valign="top"><font color="#000000">
                                  <input type="button" onclick="javascript: window.location='top_10_applicants_archived.php'; " value="Go to Archived Page" name="submit">
                                </td>
                              </tr>
                            </table>
                          </form>
...
<?php					
						...
						{
							$s_c = " AND (ratings = '0' AND sub_category_id='$sub_category')"; 
						}
