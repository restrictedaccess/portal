...
*/
function mkYearHead(){
return "<table width='100%' id='calendar_tb' cellspacing='5' class=\"".$this->cssYearTable."\">\n";
}
/*
********************************************************************************
...
function mkYearTitle(){
	...
	if (!$this->yearNav){
		...
		$out.="<table width='90%'><tr><td class=\"".$this->cssYearNav."\">";
...
return "<table width='100%' cellspacing='1' class=\"".$this->cssMonthTable."\">\n";
}
/*
********************************************************************************
...
//$linkstr="<a href=\"javascript:RequestLeave".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var.")\">".$var."</a>";
$linkstr="<a href='#' class='request_a_leave' year=".$this->actyear." month=".$this->actmonth." day=".$var.">".$var."</a>"; 
 
if ($this->javaScriptDay) $linkstr="<a href=\"javascript:".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var.")\">".$var."</a>";
//if($eventContent) $linkstr="<a href=\"javascript:ShowLeaveRequest".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var." , 0)\">".$var."</a>";
if($eventContent){
	//$linkstr=$var;
	//$linkstr="<a href=\"javascript:ShowLeaveRequestByDate".$this->javaScriptDay."(".$this->actyear.",".$this->actmonth.",".$var.")\">".$var."</a>";
	$linkstr="<a href='#' class='show_leave_request_by_date' year=".$this->actyear." month=".$this->actmonth." day=".$var.">".$var."</a>";
}
	/*
	if ($this->isEvent($var)){
		if ($this->eventUrl){
	...
	*/
	...
	if ($this->isEvent($var)){
			if ($this->eventUrl){
				...
				if($eventContent){
					$out="<td bgcolor='".$eventContent."' class='with_event'>".$linkstr."</td>";
				}else{
					$out="<td class=\"".$this->eventID."\">".$var."</td>";
				}
			}else{
				if($eventContent){
					$out="<td bgcolor='".$eventContent."' class='with_event'>".$linkstr."</td>";
				}else{
					$out="<td class=\"".$this->eventID."\">".$linkstr."</td>";
				}
			}	
	}elseif ($var==$this->selectedday && $this->actmonth==$this->selectedmonth && $this->actyear==$this->selectedyear){
			if (!$this->dayLinks){
				...
				if($eventContent){
						...
						$out="<td class=\"".$this->cssSelecDay."\">".$linkstr."</td>";
				}
			...
			if (!$this->dayLinks){
				...
				if($eventContent){
						...
						$out="<td class=\"".$this->cssToday."\">".$linkstr."</td>";
				}
			...
			if (!$this->dayLinks){
				...
				if($eventContent){
						...
						$out="<td class=\"".$this->cssSunday."\">".$linkstr."</td>";
				}
			...
			if (!$this->dayLinks){
				...
				if($eventContent){
						...
						$out="<td class=\"".$this->cssSaturday."\">".$linkstr."</td>";
				}
