...
function goto(id) 
{
	location.href = "admin_apply_action.php?id="+id+"&page=pending";
}
function check_val()
{
...
<p><label><b>Actions :</b></label><input type="submit" name="search" value="Search"> &nbsp;<input type="button" name="add" value="Add New Lead" onClick="self.location='adminaddnewlead.php'"/> &nbsp;</p>

<p><label><b>Move :</b></label> <input type="submit" name="move" value="New Leads" /> <input type="submit" name="move2" value="Follow Up" /> <input type="submit" name="move3" value="Keep in Touch" /></p>
