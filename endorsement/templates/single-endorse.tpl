...
<script type="text/javascript" src="/portal/endorsement/js/single-endorse.js"></script>
			...
			<table width=100%  cellspacing=0 cellpadding=2 border=0 align=left >
				<tr>
					<td width="86%" valign="top" align="left">
							...
							<form name="form" method="post" action="?userid={$userid}" id="leads-form">
                                      ...
                                      <td colspan="3">
                                      	<table width="100%"><tr><td valign="bottom">Insert Notes to Lead Message(optional)</td>
                                        	<td align="right">
                                                ...
                                                <a href="javascript: resume_checker('/portal/AdminResumeChecker/ResumeChecker.html?userid={ $userid }'); ">Admin Resume Checker</a>&nbsp;&nbsp;&nbsp;<a href="javascript: open_popup_resume({ $userid }); ">Preview Resume</a>
										  </td>
										</tr></table>
                                      </td>
                                    </tr>          
