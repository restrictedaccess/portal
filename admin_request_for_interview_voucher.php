...
<tr>
	...
	<td valign="top"  style="width:100%;">
					<table width="100%" border="0" bgcolor="#2A629F" cellpadding="10" cellspacing="2">
					  <tr>
						<td align="left" valign="middle" bgcolor="#2A629F" colspan="6"><font color="#FFFFFF"><strong>Voucher Manager</strong></font></td>
					  </tr>	                    
                      <tr>
					...
					<table width="100%" border="0" bgcolor="#F1F1F3" cellpadding="10" cellspacing="1">
							...
							<td align="left" valign="top" bgcolor="#ffffff"> <font color="#000000"><strong>
								...
								<table width="0%"  border="0" cellspacing="3" cellpadding="3">
									...
									<tr>
										...
										<td><input type="text" name="f_limit_of_use" id="id_f_limit_of_use" class="text" value="<?php echo $f_limit_of_use; ?>" size="5" maxlength="5"></td>
									</tr>                                    								
									<tr>
										<td scope="row"><font color="#000000"><strong>Source</strong></font></td>
									  <td>
											  <select size="1" class="text" name="f_admin_id" id="id_f_admin_id">
												<?php
													echo "<option value='".$_SESSION['admin_id']."' selected>Admin</option>";
													echo "<option value='0'>System Generated</option>";
												?>
											  </select>
										</td>							
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top" bgcolor="#F1F1F3"><font color="#000000"><strong>Limit/Total&nbsp;Used</strong></font></td>
...
?>
						  ...
						  <tr>
							...
							<td align="left" valign="top" bgcolor="#FFFFFF" onMouseOver="javascript:this.style.background='#F1F1F3';" onMouseOut="javascript:this.style.background='#ffffff'; ">
								<!--<a href="admin_request_for_interview_popup.php?v=<?php echo $found[$x]['code_number']; ?>">--><?php echo $found[$x]['code_number']; ?><!--</a>-->
							</td>
							...
							<td align="left" valign="top" bgcolor="#FFFFFF">
                            	...
                            	<table>
                                	<tr>
                                    	<td><input type="text" id="limit_of_use<?php echo $found[$x]['code_number']; ?>" class="text" value="<?php echo $found[$x]['limit_of_use']; ?>" size="5" maxlength="5"></td>
                                        <td><input type="text" id="total_used" class="text" value="<?php echo $found[$x]['total_used']; ?>" size="5" maxlength="5" readonly></td>
                                        <td><input type="submit" value="Save" name="Save" class="button" onClick="javascript: voucher_limit(<?php echo $found[$x]['code_number']; ?>); "></td>
									</tr>
								</table>
