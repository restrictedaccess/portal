...
<body bgcolor="#CCCCCC">
											<table bgcolor=#666666 border=0 cellpadding=0 cellspacing=1 width="100%">
												...
												{
													$q = "SELECT * FROM tb_app_appointment WHERE status='active' AND user_id='$agent_no' AND date_start='$d' ORDER BY start_hour";
												}												
												$c = mysql_query($q);	
																...
																<table width=100% cellspacing=1 border=0 cellpadding=7 bgcolor=#fefefe>
																	<tr>
																		...
																		<td bgcolor=#FFFFFF valign="top" align="right">
                                                                        	<i><?php if($row["start_minute"] == 0) echo $h.":"."00"."&nbsp;".$temp; else echo $h.":".$row["start_minute"]."&nbsp;".$temp; ?></i>
                                                                        </td>
