...
(function($){
	$.fn.extend(
	{
		simpleAutoComplete: function( page, options, callback )
		{
			...
			{
				alert("simpleAutoComplete: page undefined.");
			}
			...
			thisElement.keyup(function( ev )
			{
				...
				if( typeof(options) == "object" )
				{
					...
					updateElem = typeof( options.updateElem ) != "undefined" ? options.updateElem : updateElem;
				}
							...
							$('div.' + classAC + ' li').each(function( n, el )
							{
								...
								el.click(function()
								{
									...
									if( typeof( callback ) == "function" )
										callback( el.attr(attrCB).split('_'), updateElem);
