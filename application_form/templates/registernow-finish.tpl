...
{literal}
	jQuery(document).ready(function(){
		jQuery(".jobseeker").click(function(e){
...
{if $success}
<h2 style="margin-bottom: 20px;">Thanks for your application. </h2>
<p>
	To be interviewed within 2 hours* please text the email address you used in the application form and your recent job position/title to 09175337967.
</p>
<p>
	You can also walk in to our office at Trafalgar Plaza Bldg. Unit A&B 27th Flr. 105 H.V. Costa Street Salcedo Village, 1227 Makati City, Philippines.
</p>
<p style="margin-bottom: 20px;">
	*<em>If done Monday - Friday between 8.30 AM to 3.00 PM.</em>
</p>
<p align="center">
	<button class="finish-button jobseeker">Continue</button>
</p>
{/if}
