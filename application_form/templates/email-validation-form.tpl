...
<small>Your email ID (e.g. Yahoo ID, Gmail Username) is not the same as your email address</small>
</td>
</tr>
...
<div class="code-form-img"><img src="/portal/images/clksendemail.jpg" width="202" height="24" style="cursor:pointer;" onclick="SendCode()" align="texttop" /></div>
...
<tr>
<td align="right">&nbsp;</td>
<td><button class="sign_in_via_fb" id="sign_in_via_fb"></button></td>
</tr>
