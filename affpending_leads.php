...
FROM leads l
WHERE status = 'pending' AND agent_id =$agent_no ORDER BY timestamp DESC;";
}
//echo $query;
$counter = 0;
...
<div id="page_desc">
<p>Dear Affiliate, </p>
<p> A quote has been given to the following leads and averything is in place and expected sale come in.   </p>
<p>Cheers, <br>
Team RemoteStaff
</p>
 </div>
...
<div class="box_contacted_leads" >Pending Leads List
