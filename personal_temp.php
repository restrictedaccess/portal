...
<b>
<? if ($mess=="5") {echo "ERROR : Email Validation Code Number didn't matched"; }?>
<? if ($mess=="3") {echo "ERROR : Please try again"; }?>
<? if ($mess=="6") {echo "ERROR : Invalid Post"; }?>
<? if ($mess=="4") { ?>
...
<? }?>
<br>
<form method="POST" name="frmPersonal" action="personalphp_temp.php"onsubmit="return checkFields();">
...
<td>
	<INPUT maxLength=100 size=30 style='width:270px' class="text" id="email_id" name="email" value="<?php echo @$_GET["email"]; ?>" onChange="javascript: update_value(this.value); ">
	<INPUT type="button" style='width:270px' class="button" name="send_code" value="Send Code to Primary Email" onClick="javascript: validate_email();">
	<div id="responder_message"></div>
</td>
</tr>
<tr valign=top><td align=right width=30% >Code&nbsp;Number:</td>
<td><INPUT maxLength=100 size=30 style='width:270px' class="text" name="code" value="<?php echo @$_GET["code"]; ?>" ></td></tr>
...
<INPUT size='30' class='text' style="width:270px" name='fname' value="<?php echo @$_GET["fname"]; ?>"></td></tr>
<tr><td width=30% align=right>Family/Last Name :</td>
<td colspan=2 ><INPUT size="30" class=text style="width:270px" name="lname" value="<?php echo @$_GET["lname"]; ?>"></td></tr>
<tr valign=top><td align=right width=30% >Date of Birth :</td>
<td colspan=2><select name="bday" class="text">
<?php 
if(@isset($_GET["bday"]))
{
	echo "<option value=".@$_GET["bday"]." selected>".@$_GET["bday"]."</option>";
}
?>
...
{
	echo "<option value=".@$_GET["bmonth"]." selected>".@$_GET["bmonth"]."</option>";
}
?>
...
- <input type="text" name="byear" size="4" maxlength=4 style='width=50px' value="<?php echo @$_GET["byear"]; ?>"  class=text> (YYYY)</td></tr>

<tr valign=top><td align=right width=30% >Identification :<br>(Optional) &nbsp;</td>
<td colspan=2>
<select name="auth_no_type_id" style="font:8pt, Verdana">
<?php 
if(@isset($_GET["auth_no_type_id"]))
{
	echo "<option value=".@$_GET["auth_no_type_id"]." selected>".@$_GET["auth_no_type_id"]."</option>";
}
?>
...
- 
<INPUT maxLength=30 size=15 style='width=120px' class="text" name="msia_new_ic_no" value='<?php echo @$_GET["msia_new_ic_no"]; ?>'><br>&nbsp;&nbsp;
<img src='images/arrow.gif'><a href="">which one should I use?</a></td></tr>
<tr valign=top><td align=right width=30% >Gender :</td>
<td colspan=2>
<INPUT type=radio value="Female" name="gender" <?php if(@$_GET["gender"] == "Female") { echo "checked"; } ?>>Female &nbsp;&nbsp;
<INPUT type=radio value="Male" name="gender" <?php if(@$_GET["gender"] == "Male") { echo "checked"; } ?> >Male</td></tr>
...
{
	echo "<option value=".@$_GET["nationality"]." selected>".@$_GET["nationality"]."</option>";
}
?>
<? echo $countryoptions;?>
</select>
...
<table cellspacing=1 width=100% border=0 cellpadding=1 align=center>
	<tr valign=top>
		<td><input type="radio" name="permanent_residence" value="AU" <?php if(@$_GET["permanent_residence"] == "AU") { echo "checked"; } ?>>Australia</td>
		<td><input type="radio" name="permanent_residence" value="CA" <?php if(@$_GET["permanent_residence"] == "CA") { echo "checked"; } ?>>Canada</font></td>
		<td><input type="radio" name="permanent_residence" value="CN" <?php if(@$_GET["permanent_residence"] == "CN") { echo "checked"; } ?>>China</font></td>
	</tr>
	<tr>
		<td><input type="radio" name="permanent_residence" value="HK" <?php if(@$_GET["permanent_residence"] == "HK") { echo "checked"; } ?>>Hong Kong</font></td>
		<td><input type="radio" name="permanent_residence" value="IN" <?php if(@$_GET["permanent_residence"] == "IN") { echo "checked"; } ?>>India</font></td>
		<td><input type="radio" name="permanent_residence" value="ID" <?php if(@$_GET["permanent_residence"] == "ID") { echo "checked"; } ?>>Indonesia</font></td>
	</tr>
	<tr>
		<td><input type="radio" name="permanent_residence" value="JP" <?php if(@$_GET["permanent_residence"] == "JP") { echo "checked"; } ?>>Japan</font></td>
		<td><input type="radio" name="permanent_residence" value="MY" <?php if(@$_GET["permanent_residence"] == "MY") { echo "checked"; } ?>>Malaysia</font></td>
		<td><input type="radio" name="permanent_residence" value="NZ" <?php if(@$_GET["permanent_residence"] == "NZ") { echo "checked"; } ?>>New Zealand</font></td>
	</tr>
	<tr>
		<td><input type="radio" name="permanent_residence" value="PH" <?php if(@$_GET["permanent_residence"] == "") { echo "checked"; } ?>>Philippines</font></td>
		<td><input type="radio" name="permanent_residence" value="SG" <?php if(@$_GET["permanent_residence"] == "SG") { echo "checked"; } ?>>Singapore</font></td>
		<td><input type="radio" name="permanent_residence" value="TH" <?php if(@$_GET["permanent_residence"] == "TH") { echo "checked"; } ?>>Thailand</font></td>
	</tr>
	<tr>
		<td><input type="radio" name="permanent_residence" value="GB" <?php if(@$_GET["permanent_residence"] == "GB") { echo "checked"; } ?>>United Kingdom</font></td>
		<td><input type="radio" name="permanent_residence" value="US" <?php if(@$_GET["permanent_residence"] == "US") { echo "checked"; } ?>>United States</font></td>
	</tr>
</table>
</td>
</tr>
...
<td><div id="user_name_id"><?php echo @$_GET["email"]; ?></div></td></tr>
<tr valign=top><td align=right width=30% >Password :</td>
<td><INPUT maxLength=100 size=30 style='width:270px' class="text" name="pass" value="<?php echo @$_GET["pass"]; ?>" ></td></tr>
...
<td><INPUT maxLength=100 size=30 style='width:270px' class="text" name="alt_email" value="<?php echo @$_GET["alt_email"]; ?>" onChange="javascript: if (Trim(this.value) != '') {	if (Trim(this.value) == Trim(form.email.value)) { alert('Please enter your alternate email different from your Primary Email'); validated = false; return false; } else { return ValidateOneEmail(this); }}"><br>&nbsp;&nbsp;<img src='images/arrow.gif'><font class=tip>will be used if primary email is not reachable</font></td></tr><tr valign=top><td align=right width=30% >Mobile No. :</td>
<td>
<SELECT name="handphone_country_code" style='font:8pt, Verdana; width:120px'>
<option value=""></option>
<?php 
if(@isset($_GET["handphone_country_code"]))
{
	echo "<option value=".@$_GET["handphone_country_code"]." selected>".@$_GET["handphone_country_code"]."</option>";
}
?>
...
- <INPUT maxLength=15 size=15 style='width:136px' class="text" name="handphone_no" value="<?php echo @$_GET["handphone_no"]; ?>">
</td></tr>
<tr valign=top><td align=right width=30% >Telephone No. :</td>
<td><INPUT maxLength=5 size=5 style='width:60px' class="text" name="tel_area_code" value="<?php echo @$_GET["tel_area_code"]; ?>"> 
- <INPUT maxLength=20 size=22 style='width:196px' class=text name="tel_no" value="<?php echo @$_GET["tel_no"]; ?>"><br>
<font class=tip>Area Code - Number</font></td></tr>
<tr valign=top><td align=right width=30% valign=top >Address 1:</td><td>
<textarea  rows="3"  style='width:270px' class="text" name="address1" id="address1"><?php echo @$_GET["address1"]; ?></textarea></td></tr>

<tr valign=top><td align=right width=30% valign=top >Address 2:</td><td><textarea  rows="3"  style='width:270px' class="text" name="address2" id="address2"><?php echo @$_GET["address2"]; ?></textarea></td></tr>
<tr valign=top><td align=right width=30% >Postal Code :</td>
<td><INPUT maxLength=20 size=30 style='width:270px' class="text" name="postcode" value="<?php echo @$_GET["postcode"]; ?>"></td></tr>
...
{
	echo "<option value=".@$_GET["country_id"]." selected>".@$_GET["country_id"]."</option>";
}
?>
...
<?php 
if(@isset($_GET["msia_state_id"]))
{
	echo "<option value=".@$_GET["msia_state_id"]." selected>".@$_GET["msia_state_id"]."</option>";
}
?>
...
<INPUT maxLength=20 size=30 style='width:270px' class="text" name="state" value="<?php echo @$_GET["state"]; ?>" ><input type=hidden name="state2" value="<?php echo @$_GET["state2"]; ?>"></td></tr><tr valign=top><td align=right width=30% >City :</td>
<td><input type=hidden name=location_code value="<?php echo @$_GET["location_code"]; ?>"><INPUT maxLength=20 size=30 style='width:270px' class="text" name="city" value="<?php echo @$_GET["city"]; ?>"></td></tr>
<tr>
  <td width=100% bgcolor=#DEE5EB colspan=3><b>Working at Home Capabilities</b></td>
</tr>
<tr valign=top><td align=right width=30% >Home Working Environment :</td><td><input type="radio" name="home_working_environment" value="private room" <?php if(@$_GET["home_working_environment"] == "private room") { echo "checked"; } ?>>Private Room&nbsp;<input type="radio" name="home_working_environment" value="shared room" <?php if(@$_GET["home_working_environment"] == "shared room") { echo "checked"; } ?>>Shared Room&nbsp;<input type="radio" name="home_working_environment" value="living room" <?php if(@$_GET["home_working_environment"] == "living room") { echo "checked"; } ?>>Living Room&nbsp;</td></tr>
<tr valign=top><td align=right width=30% >Internet Connection :</td><td><input type="radio" name="internet_connection" value="WI-FI" <?php if(@$_GET["internet_connection"] == "WI-FI") { echo "checked"; } ?>>WI-FI&nbsp;<input type="radio" name="internet_connection" value="DIAL-UP" <?php if(@$_GET["internet_connection"] == "DIAL-UP") { echo "checked"; } ?>>Dial-Up&nbsp;<input type="radio" name="internet_connection" value="DSL" <?php if(@$_GET["internet_connection"] == "DSL") { echo "checked"; } ?>>DSL&nbsp;</td></tr>
<tr valign=top><td align=right width=30% >Internet Provider (ISP) :</td><td><INPUT size=30 style='width:270px' class="text" name="isp" value="<?php echo @$_GET["isp"]; ?>"></td></tr>
<tr valign=top><td align=right width=30% >List of Computer Harwdare:</td><td><textarea name="computer_hardware" cols="30" rows="5"><?php echo @$_GET["computer_hardware"]; ?></textarea></td></tr>
...
<?php 
if(@isset($_GET["headset_quality"]))
{
	echo "<option value=".@$_GET["headset_quality"]." selected>".@$_GET["headset_quality"]."</option>";
}
?>
<option value=1>1</option>
<option value=2>2</option>
...
</table><br clear=all><table width=100% cellspacing=8 cellpadding=2 border=0 align=left ><tr><td width=100% bgcolor=#DEE5EB colspan=3><b>&nbsp;Online Contact Info (OPTIONAL)</a></b></td></tr><tr><td><div id='internet_acc' class='toggleshow'><table width='100%' cellpadding=2 cellspacing=4 border=0><tr valign=top><td align=left colspan=2><a name='ia'>Fill in your Instant Messaging (IM) Usernames here to provide us with an alternative way to contact you. <font color=red><b>Note: This section is fully optional.</b></font></a><br><br></td></tr><tr valign=top><td align=right width=30% >MSN Messenger ID :</td><td><INPUT maxLength=80 size=30 style='width:200px' class=text name="msn_id" value="<?php echo @$_GET["msn_id"]; ?>"></td></tr><tr valign=top><td align=right width=30% >Yahoo! Messenger ID :</td><td><INPUT maxLength=80 size=30 style='width:200px' class="text" name="yahoo_id" value="<?php echo @$_GET["yahoo_id"]; ?>"></td></tr><tr valign=top><td align=right width=30% >ICQ Number :</td><td><INPUT maxLength=80 size=30 style='width:200px' class=text name="icq_id" value="<?php echo @$_GET["icq_id"]; ?>"></td></tr><tr valign=top><td width=30% height="57" align=right >Skype ID :</td>
<td><INPUT maxLength=80 size=30 style='width:200px' class="text" name="skype_id" value="<?php echo @$_GET["skype_id"]; ?>"></td></tr><tr><td colspan=2>
<p> <div align="center">
