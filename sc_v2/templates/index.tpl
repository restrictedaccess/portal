...
<input type="hidden" name="PHPRATE" id="PHPRATE" value="{$PHPRate}"/>
...
<script src="js/quote/dashboard.js"></script>
{*<script src="js/quote.js"></script>*}
<script src="js/quote/client.js"></script>
<script src="js/quote/details.js"></script>
<script src="js/quote/main.js"></script>
<script src="js/files/quote_files.js"></script>
<script src="js/quote/sa_info_list.js"></script>
<script src="js/quote/service_agreement.js"></script>
<script src="js/quote/service_agreement_info.js"></script>
