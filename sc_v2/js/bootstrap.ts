...
declare let phase1:any;
declare let phase2:any;
declare let phase3:any;
...
let dependencies = ["plugins/moment/moment.min","plugins/daterangepicker/daterangepicker","plugins/daterangepicker/angular-daterangepicker", "jquery/jquery-2.1.1.min","plugins/jquery-ui/jquery-ui","bootstrap/bootstrap.min","plugins/metisMenu/jquery.metisMenu", "plugins/slimscroll/jquery.slimscroll.min",
