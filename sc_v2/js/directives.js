    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'REMOTESTAFF | Responsive Admin Theme';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'REMOTESTAFF | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
function dropZone() {
    return function(scope, element, attrs) {
        ...
        if (config!=null){;
            ...
            jQuery(element).dropzone(config);
        }else{
            element.dropzone({
                url: "/upload",
                maxFilesize: 100,
 ...
 */
function simpleFileUploadModel(){
    return {
        scope: {
            "fileModel": "=fileModel"
        },        //create a new scope
...
angular
    ...
    .directive('simpleFileUploadModel', simpleFileUploadModel)
