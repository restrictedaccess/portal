...
//  removed Add notes functionality
*}

{if $month_options}
<div id="div_select_month">Select Month : 
...
<div id="div_add_notes" class="invisible">
    <div id="div_title_add_notes">Add Notes</div>
    <div><textarea rows="4" id="input_add_notes"></textarea></div>
    <input type="hidden" id="add_notes_blank" value=""/>
    <input type="hidden" id="add_notes_record_id" value=""/>
    <input type="hidden" id="add_notes_date" value=""/>
    <div><button id="button_save_notes">Save</button> <button id="button_cancel_notes">Cancel</button></div>
</div>
{/if}
